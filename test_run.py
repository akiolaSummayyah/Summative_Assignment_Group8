#This is just a test run file for the borrowing system. It creates a resource and simulates borrowing and returning it by different students, then displays the borrowing records.
